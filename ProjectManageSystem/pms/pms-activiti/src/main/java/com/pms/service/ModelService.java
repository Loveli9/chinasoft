...
public class ModelService {
    ...
    public Model create(String name, String key, String desc, String category) {
        try {
            ...
            properties.put("process_author", "pms");
            ...
            throw new PMSException(HttpCodeEnum.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public String deploy(String id) {
        ...
        try {
            ...
            if (list.size() == 0){
                throw new PMSException(HttpCodeEnum.MODEL_NOT_EXIST);
            }
            ...
            throw new PMSException(HttpCodeEnum.FAIL);
        }
        return message;
    }
}
