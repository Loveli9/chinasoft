...
<head>
    ...
    <link href="${rc.contextPath}/css/pms.css" rel="stylesheet">
    ...
    <script src="${rc.contextPath}/js/pms/pms.js"></script>
    <script src="${rc.contextPath}/js/pms/pmsform.js"></script>
</head>
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    ...
                    <form class="form-horizontal form-bordered" id="pmsForm">
