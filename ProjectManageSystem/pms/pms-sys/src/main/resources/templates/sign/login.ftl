...
<head>
    ...
    <title>登陆页</title>
    <meta name="keywords" content="中软项目管理系统">
    <meta name="description" content="中软项目管理系统">
...
<div class="signinpanel">
    ...
    <div class="signup-footer">
        <div style="text-align: center;">&copy; 2019 chinasoft
        </div>
    </div>
</div>
<!-- 全局js -->
...
<script src="${base}/js/pms/toast.js"></script>
